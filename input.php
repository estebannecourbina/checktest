  ...
  <html>
    ...
    <!-- <form id="form1" name="form1" method="post" action="https://www.sofort.com/payment/start"> -->
     <form name="frm" method="post" action="verification.php">
        <fieldset id="form">
          <legend> Nochmal Hallo Hallo Companeros input </legend>
          <OL>
            ...
            <li><label>sender_country_id</label><input type="text" name="country_id" value="" /></li>
            <li><label>sender_bank_code</label><input type="text" name="bank_code" value="" /></li>
            <li><label>sender_holder</label><input type="text" name="holder" value="" /></li>
            <li><label>sender_account_number</label><input type="text" name="account_number" value="" /></li>
